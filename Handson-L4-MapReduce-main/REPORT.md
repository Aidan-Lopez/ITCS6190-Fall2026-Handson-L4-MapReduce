...
---
  ...
  I also could see the job present in the Resource Manager, and other jobs from previous runs. When the program finished, I saw the word count of each word in the input.
